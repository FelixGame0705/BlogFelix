    ...
    <Layout className="layout" >
      ...
      >
        ...
        <div className="custom-logo">
          <Link to="/" style={{ color: "white", fontSize: "20px" }}><Image width={100} src="https://res.cloudinary.com/dno1kjdkk/image/upload/v1730870757/AI_Generated_Logo_2024-11-06_ad63217e-ffed-4292-b3f4-c58e34fe7cf5-removebg-preview_ooc9mf.png" preview={false}/></Link>
        </div>
